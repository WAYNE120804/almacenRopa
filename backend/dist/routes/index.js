...
const bot_routes_1 = require("../modules/bot/bot.routes");
const caja_routes_1 = require("../modules/cajas/caja.routes");
const cliente_recibo_routes_1 = require("../modules/cliente-recibos/cliente-recibo.routes");
...
const supervision_routes_1 = require("../modules/supervision/supervision.routes");
...
exports.apiRouter.use('/bot', bot_routes_1.botRouter);
...
exports.apiRouter.use('/cliente-recibos', cliente_recibo_routes_1.clienteReciboRouter);
...
exports.apiRouter.use('/supervision', supervision_routes_1.supervisionRouter);
